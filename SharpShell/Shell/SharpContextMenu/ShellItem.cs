...
namespace Shell.SharpContextMenu
{
    ...
    //        if (ILShell32.SHGetSpecialFolderLocation(IntPtr.Zero,
    ...
    //            uint eaten = 0;
    //            IntPtr pidl;
    //            SFGAO attributes = SFGAO.NONE;

    //            folder.ParseDisplayName(IntPtr.Zero, 
    //                null, // IntPtr.Zero,
    //                name, ref eaten, out pidl, ref attributes);
    ...
    //    {
    //        return GetEnumerator(SHCONTF.SHCONTF_FOLDERS | SHCONTF.SHCONTF_INCLUDEHIDDEN |
    ...
    //        //CreateViewObject(IntPtr hwndOwner, [In] ref Guid riid, out IntPtr ppv);
    //        var result = folder.CreateViewObject(control.Handle,
    //            typeof(IDropTarget).GUID, out ppv);
    //        return (IDropTarget)Marshal.GetTypedObjectForIUnknown(ppv,
    //                typeof(IDropTarget));
    //    }
    ...
    //        IntPtr result = ILShell32.SHGetFileInfo(Pidl, 0, out info,
    //            Marshal.SizeOf(info),
    //            SHGFI.SHGFI_ICON | SHGFI.SHGFI_SYSICONINDEX | SHGFI.SHGFI_OVERLAYINDEX | SHGFI.SHGFI_PIDL |
    ...
    //    {
    //        return IsFolder && ILShell32.ILIsParent(Pidl, item.Pidl, true);
    //    }
    ...
    //    {
    //        return IsFolder && ILShell32.ILIsParent(Pidl, item.Pidl, false);
    //    }
    ...
    //    {
    //        get { return m_ComInterface.GetAttributes(SFGAO.SFGAO_HASSUBFOLDER) != 0; }
    //    }
    ...
    //    {
    //        get { return m_ComInterface.GetAttributes(SFGAO.SFGAO_FILESYSTEM) != 0; }
    //    }
    ...
    //    {
    //        get { return m_ComInterface.GetAttributes(SFGAO.SFGAO_FILESYSANCESTOR) != 0; }
    //    }
    ...
    //    {
    //        get { return m_ComInterface.GetAttributes(SFGAO.SFGAO_FOLDER) != 0; }
    //    }
    ...
    //    {
    //        get { return m_ComInterface.GetAttributes(SFGAO.SFGAO_READONLY) != 0; }
    //    }
    ...
    //                ILShell32.SHGetSpecialFolderLocation(
    ...
    //        if (RunningVista)
    //        {
    //            return ILShell32.SHCreateItemFromIDList(pidl,
    ...
    //        if (RunningVista)
    //        {
    //            return ILShell32.SHCreateItemFromParsingName(path, IntPtr.Zero,
    //                typeof(IShellItem).GUID);
    //        }
    //        else
    //        {
    ...
    //            desktop.ParseDisplayName(IntPtr.Zero, null, // IntPtr.Zero,
    //                path, ref eaten, out pidl, ref attributes);
    //            //Interop.VistaBridge.
    //            return new ShellItemImpl(
    //                pidl, true);
    //        }
    ...
    //        if (RunningVista)
    //        {
    //            return ILShell32.SHCreateItemWithParent(IntPtr.Zero,
    ...
    //        if (RunningVista)
    //        {
    //            return ILShell32.SHGetIDListFromObject(item);
    //        }
    //        else
    //        {
    //            //Interop.VistaBridge.
    ...
    //        if (folder.EnumObjects(IntPtr.Zero, flags, out result) == (int)HResult.S_OK)
    //        {
    //            return result;
    //        }
    //        else
    ...
    //    LargeIcon = SHGFI.SHGFI_LARGEICON,

    //    /// <summary>The system shell icon type</summary>
    //    ShellIcon = SHGFI.SHGFI_SHELLICONSIZE,

    //    /// <summary>The system small icon type</summary>
    //    SmallIcon = SHGFI.SHGFI_SMALLICON,
    //}
    ...
    //    OpenIcon = SHGFI.SHGFI_OPENICON,

    //    /// <summary>Get the overlay for the icon as well.</summary>
    //    OverlayIndex = SHGFI.SHGFI_OVERLAYINDEX
    //}
