    ...
    internal class ShellNamespaceFolderIdListEnumerator : IEnumIDList
    {
        ...
        public int Next(uint celt, IntPtr rgelt, out uint pceltFetched)
        {
            ...
            catch (Exception exception)
            {
                ...
                Trace.WriteLine(
                    string.Format("An unhandled exception occured enumerating {0} items from the {1} namespace extension.", celt, shellNamespaceFolder.GetDisplayName(DisplayNameContext.Normal)),
                    exception.Message);
            }
