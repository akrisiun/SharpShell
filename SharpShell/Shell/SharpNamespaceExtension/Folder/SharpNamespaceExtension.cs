...
namespace SharpShell.SharpNamespaceExtension
{
    ...
    #region Implmentation of IShellFolder and IShellFolder2
        ...
        public int ParseDisplayName(IntPtr hwnd, IBindCtx pbc, string pszDisplayName, ref uint pchEaten, 
        ...
        {
            //  Use the ShellFolderImpl to handle the details.
            return ((IShellFolder)shellFolderImpl).BindToObject(pidl, pbc, riid, out ppv);
        }
        ...
        /// </returns>
        //  int IShellFolder.
        public int GetUIObjectOf(IntPtr hwndOwner, uint cidl, 
            IntPtr[] apidl, 
            ref Guid riid, uint rgfReserved, out IntPtr ppv)
        {
            //  Use the ShellFolderImpl to handle the details.
            return ((IShellFolder)shellFolderImpl).GetUIObjectOf(hwndOwner, cidl, 
                apidl, ref riid, rgfReserved, out ppv);
        }
       ...
       // int ParseDisplayName(IntPtr hwnd, Interop.IBindCtx pbc, string pszDisplayName, ref uint pchEaten, out IntPtr ppidl,
       //                      ref SFGAO pdwAttributes);
        ...
        {
            return ((IShellFolder2)shellFolderImpl).BindToObject(pidl, pbc, riid, out ppv);
        }
        ...
        public int GetUIObjectOf(IntPtr hwndOwner, uint cidl, 
            IntPtr[] apidl, 
            ref Guid riid, uint rgfReserved,
            out IntPtr ppv)
        {
            return ((IShellFolder2)shellFolderImpl)
                .GetUIObjectOf(hwndOwner, cidl, apidl, ref riid, rgfReserved, out ppv);
        }
        */

        int IShellFolder2.GetDisplayNameOf(IntPtr pidl, SHGDNF uFlags, out _STRRET pName)
        {
