...
namespace SharpShell.Interop
{
    ...
    public interface IShellFolder2 : IShellFolder, IOleContainer2
    {
        ...
        [PreserveSig]
        new int BindToObject(IntPtr pidl, IntPtr pbc, 
        ...
        [PreserveSig]
        new int GetDisplayNameOf(IntPtr pidl, SHGDNF uFlags, out _STRRET pName);
        [PreserveSig]
