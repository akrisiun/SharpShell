...
namespace SharpShell.Interop
{
    ...
    public interface IShellFolder // : IOleContainer2
    {
        /// <summary>
        ...
        int ParseDisplayName(IntPtr hwnd,
            [In] IBindCtx pbc, // IntPtr pbc
            [In, MarshalAs(UnmanagedType.LPWStr)] 
            string pszDisplayName,
            ref uint pchEaten, out IntPtr ppidl,
        ...
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        int BindToObject(IntPtr pidl, IntPtr pbc,
        ...
        /// <returns>If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [PreserveSig]
        int GetDisplayNameOf(IntPtr pidl, SHGDNF uFlags, out _STRRET pName);
    ...
    //[ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    //[Guid("000214E6-0000-0000-C000-000000000046")]
    //public interface IShellFolder_
    //{
    //    [PreserveSig]
    //    int ParseDisplayName(IntPtr hwnd,
    //        [In] IBindCtx pbc, // IntPtr pbc
    ...
    public interface IOleContainer2 // : IMalloc
    {
        [PreserveSig]
