...
namespace SharpShell.Interop
{
    ...
    public static class Shell32
    {
        ...
        public static Guid IID_IShellFolder = typeof(IShellFolder).GUID;
    ...
    public static class Shell32Ext
    {
        [DllImport("shell32.dll")]
        public static extern int SHGetDesktopFolder(out IShellFolder2 ppshf);

        //[DllImport("shell32.dll")]
        //public static extern int SHGetDesktopFolder(out IShellFolder_ ppshf);
    }
