...
namespace SharpShell
{
    ...
    public abstract class SharpShellServer : ISharpShellServer
    {
        ...
        {
            // Logging.Log
            Trace.WriteLine(String.Format("Registering server for type {0}", type.Name));
        ...
        {
            // Logging.Log
            Trace.WriteLine(String.Format("Unregistering server for type {0}" + type.Name));
        ...
        protected virtual void Log(string message)
        {
            ...
            //Logging.Log
            Trace.WriteLine(DisplayName + ": " + message);
        }
        ...
        protected virtual void LogError(string message, Exception exception = null)
        {
            ...
            //Logging.Error
            Trace.WriteLine(string.Format("{0} : {1} ({2})", DisplayName, message,
